...
using System;
using Vorn.Tamin.Kiota.Auth;
using Vorn.Tamin.Kiota.Interface;
namespace Vorn.Tamin.Kiota
{
    ...
    public partial class TaminOpenAPIClient : BaseRequestBuilder
    {
        ...
        {
            get => new global::Vorn.Tamin.Kiota.Auth.AuthRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The interface property</summary>
        public global::Vorn.Tamin.Kiota.Interface.InterfaceRequestBuilder Interface
        {
